...
def imageflow_demo(detection_file, video_path, image_folder, output_path, tracker_params,output_folder): 
    ...
    with open(results_csv, mode='w', newline='') as csvfile:
        ...
        while True:
            ...
            # if not dets and frame_id in detections:
...
if __name__ == "__main__":
    ...
    image_folder = "C:/Users/DELL/Desktop/p3"  # 图像文件夹路径
    output_path = "C:/Users/DELL/Desktop/p4_output.avi"
    output_folder="C:/Users/DELL/Desktop/p4" 
    # Tracker parameters
    tracker_params = {
        "det_thresh": 0.5,
        "iou_threshold": 0.3,
