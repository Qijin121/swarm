...
from datetime import datetime
from cam.msg import LightInfo, Cam1, Detection, Dects, TrackStatus
...
class Tracker:
    def __init__(self, output_path, tracker_params):
        ...
        # ROS发布者
        self.tracking_pub = rospy.Publisher('/tracker_1', TrackStatus, queue_size=10)
...
class Camera(object):
    def __init__(self, Cam_ID):
        ...
        self.det_pub = rospy.Publisher('/Det1', Dects, queue_size=10)
