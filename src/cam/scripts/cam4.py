...
class Tracker:
    def __init__(self, output_path, tracker_params):
        ...
        # ROS发布者
        self.tracking_pub = rospy.Publisher('/tracker_4', TrackStatus, queue_size=10)
...
class Camera(object):
    def __init__(self, Cam_ID):
        rospy.init_node('Cam4_node', anonymous=True)
        self.bridge = CvBridge()
        self.light_pub = rospy.Publisher('/Cam4', Cam4, queue_size=100)
        self.det_pub = rospy.Publisher('/Det4', Dects, queue_size=10)
...
if __name__ == '__main__':
    ...
    pose_dir = f"Data/{folder_name}/Cam4/data.mat"
